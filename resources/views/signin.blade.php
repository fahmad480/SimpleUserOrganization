                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="/" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">RentCar</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to RentCar!</h4>
                                <p class="card-text mb-2">Rent a car has never been easier than this.</p>
